(function($){
   ...
   var options = {
        ...
        "fnCreatedRow" :  function( nRow, aData, iDataIndex ) {
          ...
          $(nRow).bind("click", function(e){
             $.get('https://localhost:8089/files?path='+ path).then(function(data){
              table.fnClearTable();
          ...
          { "sTitle": "", "mData": null, "bSortable": false, "sClass": "head0", "sWidth": "55px",
            "render": function (data, type, row, meta) {
              if (data.IsDirectory) {
                ...
                return "<a  onclick='loadEditorContent(\"https://localhost:8089/b?" 
                + rstr 
                + "f=" 
                + data.Path 
  ...
  $.get('https://localhost:8089/files').then(function(data){
      table.fnClearTable();
      table.fnAddData(data);
  });
